...
//   return (
//     <header classNameName="bg-black text-white py-4 px-8 flex justify-between items-center">
//       <Link to="/" classNameName="text-3xl font-bold text-white">Clothing</Link>
//       <nav classNameName="flex gap-6 items-center">
//         <Link to="/" classNameName="hover:text-gray-400">Trang chủ</Link>
//         <Link to="/design" classNameName="hover:text-gray-400">Thiết kế áo</Link>
//         <Link to="/cart" classNameName="hover:text-gray-400 relative">
//           <ShoppingCart />
//           {totalItems > 0 && (
//             <span classNameName="absolute -top-2 -right-2 bg-red-500 text-white rounded-full text-xs px-1">
//               {totalItems}
//             </span>
//           )}
//         </Link>
//         {user ? (
//           <button onClick={handleLogout} classNameName="hover:text-gray-400">Đăng xuất</button>
//         ) : (
//           <>
//             <Link to="/login" classNameName="hover:text-gray-400">Đăng nhập</Link>
//             <Link to="/register" classNameName="hover:text-gray-400">Đăng ký</Link>
//           </>
//         )}
//       </nav>
//     </header>
      ...
      <nav className="hidden md:flex gap-6 items-center">
        ...
        <div className="relative group">
          ...
          <div className="absolute left-0   top-full max-w-64 w-56 bg-black border border-gray-700 rounded-lg  hidden group-hover:block z-50">
            <Link to="/design" className="block px-4 py-2 hover:bg-gray-800 ">BẢNG GIÁ ĐỒNG PHỤC</Link>
